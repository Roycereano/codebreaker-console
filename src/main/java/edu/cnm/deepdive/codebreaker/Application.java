...
public class Application {
    ...
    try {
      ...
      do {
        try {
          ...
          Guess guess = application.sumbitGuess(text);
  ...
  private Guess sumbitGuess(String text) throws IOException, BadGuessException {
  ...
  private void printGuessResults(Guess guess) {
    System.out.printf(bundle.getString("guess_results"),
        guess.getText(), guess.getExactMatches(), guess.getExactMatches());
    if (guess.isSolution()) {
